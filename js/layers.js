...
addLayer("p", {
    ...
    infoboxes: {
        A: {
            ...
            body() {
                ...
                if (hasUpgrade('p', 93)){text += "Cat Ascii Art by Blazej Kozlowski "}
                return text
            }
        },
    },
    ...
    buyables: {
        11: {
            ...
            title() { if (hasUpgrade('p', 103)) {return ""} else {return "prestige buyable 11"}},
            display() { 
                ...
                if (hasUpgrade('p', 103)) {return cat+text} else {return nocat+text}},
